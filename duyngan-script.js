(function ($) {
    ...
    setTimeout(function () {
        ...
        $(".invitation-box").css(
            "height",
            Math.max(boxHeightOne, boxHeightTwo)
        );
    }, 300);
