...
function tzlib_get_content(e) {
    ...
    return (3 !== e.length ||
        (tzlibZonesDB["" + e[0]] &&
            tzlibZonesDB["" + e[0]]["" + e[1]] &&
            tzlibZonesDB["" + e[0]]["" + e[1]]["" + e[2]])) &&
        (2 !== e.length ||
            (tzlibZonesDB["" + e[0]] && tzlibZonesDB["" + e[0]]["" + e[1]])) &&
        (1 !== e.length || tzlibZonesDB["" + e[0]])
        ? 3 === e.length
            ? [
                  tzlibZonesDB["" + e[0]]["" + e[1]]["" + e[2]][0],
                  tzlib_enrich_data(
                      tzlibZonesDetailsDB[
                          tzlibZonesDB["" + e[0]]["" + e[1]]["" + e[2]][1]
                      ]
                  ),
              ]
            : 2 === e.length
            ? [
                  tzlibZonesDB["" + e[0]]["" + e[1]][0],
                  tzlib_enrich_data(
                      tzlibZonesDetailsDB[tzlibZonesDB["" + e[0]]["" + e[1]][1]]
                  ),
              ]
            : [
                  tzlibZonesDB["" + e[0]][0],
                  tzlib_enrich_data(
                      tzlibZonesDetailsDB[tzlibZonesDB["" + e[0]][1]]
                  ),
              ]
...
function tzlib_get_offset(e, a, t) {
    ...
    if (!t.match(/^\d{2}:\d{2}$/))
        return (
            console.error(
                "offset calculation failed: time misspelled [-> hh:mm]"
            ),
            ""
        );
    ...
    for (let e = 0; e < r.length; e++)
        r["" + e].startsWith("TZOFFSETTO") &&
            (c++, (s["" + c].offset = r["" + e].split(":")[1])),
            r["" + e].startsWith("DTSTART") &&
                (s["" + c].hour = parseInt(r["" + e].substr(17, 2))),
            r["" + e].startsWith("RRULE") &&
                ((o = r["" + e].split(";")),
                (i = parseInt(o[1].split("=")[1])),
                (s["" + c].month = parseInt(i)),
                (s["" + c].day = o[2].split("=")[1]));
    if (
        (s[1].month > s[2].month && ([s[1], s[2]] = [s[2], s[1]]),
    ...
    var g,
        t =
            "-" == s["" + d].day[0]
                ? ((g = s["" + d].day.substr(2, 2)),
                  (e =
                      Object.keys(p["" + g]).length +
                      1 -
                      parseInt(s["" + d].day[1])),
                  p["" + g]["" + e])
                : ((g = s["" + d].day.substr(1, 2)),
                  p["" + g][s["" + d].day[0]]);
    return (
        t < l || (l == t && a >= s["" + d].hour)
            ? s["" + d]
 ...
 */ const atcbVersion = "1.18.7",
    ...
    isChrome = isBrowser()
        ? () =>
              !!/chrome|chromium|crios|google inc/i.test(
...
function atcb_decorate_data(e) {
    return (
        ((e = atcb_decorate_data_identifier(e)).subscribe =
            atcb_decorate_data_subscribe(e)),
        ((e = atcb_decorate_data_options(
            (e = atcb_decorate_data_rrule(e))
        )).richData = atcb_decorate_data_rich_data(e)),
        ...
        (e = atcb_decorate_data_extend(
            (e = atcb_decorate_data_meta(
                (e = atcb_decorate_data_dates(
                    (e = atcb_decorate_data_i18n(
                        (e = atcb_decorate_data_style(e))
                    ))
                ))
            ))
        ))
    ...
    if (null != e.recurrence && "" != e.recurrence)
        if (
            ...
            if (/^RRULE:/i.test(e.recurrence)) {
                ...
                (null != e.recurrence_interval &&
                    "" != e.recurrence_interval) ||
                    (e.recurrence_interval = 1),
                    (null == e.recurrence_weekstart ||
                        ("" == e.recurrence_weekstart) |
                            (2 < e.recurrence_weekstart.length)) &&
                        ...
                        (null != e.endTime && "" != e.endTime
                            ...
                            : (e.recurrence =
                                  ...
                                  e.recurrence_until
                                      .replace(/-/g, "")
                                      .slice(0, 8))),
                    null != e.recurrence_count &&
                        "" != e.recurrence_count &&
                        (e.recurrence =
                            e.recurrence + ";COUNT=" + e.recurrence_count),
                    null != e.recurrence_byDay &&
                        "" != e.recurrence_byDay &&
                        (e.recurrence =
                            e.recurrence + ";BYDAY=" + e.recurrence_byDay),
                    null != e.recurrence_byMonth &&
                        "" != e.recurrence_byMonth &&
                        (e.recurrence =
                            e.recurrence + ";BYMONTH=" + e.recurrence_byMonth),
                    null != e.recurrence_byMonthDay &&
...
function atcb_decorate_data_options(a) {
    isiOS() &&
        a.options.includes("ical") &&
        !a.options.includes("apple") &&
        a.options.push("apple");
    var t = [];
    a.optionLabels = [];
    for (let e = 0; e < a.options.length; e++) {
        ...
        (isiOS() && atcbiOSInvalidOptions.includes(n)) ||
            (null != a.recurrence &&
                "" != a.recurrence &&
                (!atcbValidRecurrOptions.includes(n) ||
                    (null != a.recurrence_until &&
                        "" != a.recurrence_until &&
                        ("apple" == n || "ical" == n)))) ||
...
function atcb_decorate_data_style(e) {
    if (
        ...
        0 <= a[0] && a[0] < 11 && (e.sizes.l = 10 + a[0]),
            2 < a.length
                ? (0 <= a[1] && a[1] < 11 && (e.sizes.m = 10 + a[1]),
                  0 <= a[2] && a[2] < 11 && (e.sizes.s = 10 + a[2]))
                : 2 == a.length &&
                  0 <= a[1] &&
                  a[1] < 11 &&
                  (e.sizes.m = e.sizes.s = 10 + a[1]);
    }
    ...
    return (
        ...
        (e.iconModal = !0),
        null != e.icons &&
            ((e.icons = String(e.icons)),
            "" != e.icons &&
                ("false" == (n = e.icons.split("|"))[0] && (e.iconButton = !1),
                null != n[1] && "false" == n[1] && (e.iconList = !1),
                null != n[2] && "false" == n[2] && (e.iconModal = !1))),
        (e.textLabelButton = !0),
        (e.textLabelList = !0),
        null != e.textLabels &&
            ((e.textLabels = String(e.textLabels)),
            "" != e.textLabels &&
                ("false" == (n = e.textLabels.split("|"))[0] &&
                    (e.textLabelButton = !1),
    ...
    if (null != a.dates && 0 < a.dates.length)
        for (let e = 0; e < a.dates.length; e++) {
            ...
            (a.dates["" + e].startTime = t.startTime),
                ...
                (a.dates["" + e].startDate = atcb_date_calculation(
                    t.startDate
                )),
        ...
        (a.dates = []),
            ...
            (a.startDate = a.dates[0].startDate =
                atcb_date_calculation(e.startDate)),
            (a.endDate = a.dates[0].endDate = atcb_date_calculation(e.endDate));
    }
    e = new Date();
    return (
        (null != a.created && "" != a.created) ||
            (a.created = atcb_format_datetime(e, "clean", !0)),
        (null != a.updated && "" != a.updated) ||
            (a.updated = atcb_format_datetime(e, "clean", !0)),
        a
    );
}
function atcb_decorate_data_meta(e) {
    return (
        (null != e.status && "" != e.status) || (e.status = "CONFIRMED"),
...
function atcb_decorate_data_description(e, a) {
    return (
        null != e.dates["" + a].description && "" != e.dates["" + a].description
            ? ((e.dates["" + a].descriptionHtmlFree =
                  atcb_rewrite_html_elements(e.dates["" + a].description, !0)),
              (e.dates["" + a].description = atcb_rewrite_html_elements(
                  e.dates["" + a].description
              )))
            : null == e.dates["" + a].description &&
              null != e.description &&
              "" != e.description
            ? ((e.dates["" + a].descriptionHtmlFree =
                  atcb_rewrite_html_elements(e.description, !0)),
              (e.dates["" + a].description = atcb_rewrite_html_elements(
                  e.description
              )))
            : (e.dates["" + a].descriptionHtmlFree = e.dates[
                  "" + a
              ].description =
                  ""),
        e
...
function atcb_decorate_data_extend(a) {
    for (let e = 0; e < a.dates.length; e++)
        (null !=
            (a = atcb_decorate_data_description(a, e)).dates["" + e].name &&
            "" != a.dates["" + e].name) ||
            (a.dates["" + e].name = a.name),
            null == a.dates["" + e].status
                ? (a.dates["" + e].status = a.status.toUpperCase())
                : (a.dates["" + e].status =
                      a.dates["" + e].status.toUpperCase()),
            null == a.dates["" + e].sequence &&
                (a.dates["" + e].sequence = a.sequence),
            null == a.dates["" + e].location &&
                null != a.location &&
                (a.dates["" + e].location = a.location),
            null == a.dates["" + e].organizer &&
                null != a.organizer &&
                (a.dates["" + e].organizer = a.organizer),
            null == a.dates["" + e].availability && null != a.availability
                ? (a.dates["" + e].availability = a.availability.toLowerCase())
                : null != a.dates["" + e].availability &&
                  (a.dates["" + e].availability =
                      a.dates["" + e].availability.toLowerCase()),
            null == a.dates["" + e].uid &&
                (a.dates["" + e].uid = atcb_generate_uuid());
    return (
        null != a.recurrence &&
            "" != a.recurrence &&
        ...
        ["start", "end"].forEach(function (e) {
            ...
            null != n[e + "Date"] &&
                ((n[e + "Date"] = n[e + "Date"]
                    .replace(/\.\d{3}/, "")
                    .replace("Z", "")),
                null != (a = n[e + "Date"].split("T"))[1] &&
                    ((n[e + "Date"] = a[0]), (n[e + "Time"] = a[1]))),
                null != n[e + "Time"] &&
                    8 === n[e + "Time"].length &&
                    ((a = n[e + "Time"]),
...
function atcb_date_calculation(e) {
    ...
    e =
        t[0].length < 4
            ? new Date(Date.UTC(t[2], t[0] - 1, t[1]))
            : new Date(Date.UTC(t[0], t[1] - 1, t[2]));
    return (
        null != a[1] && 0 < a[1] && e.setDate(e.getDate() + parseInt(a[1])),
...
function atcb_validate(e) {
    ...
    return (
        !!atcb_validate_icsFile(e, a) &&
        !!atcb_validate_subscribe(e, a) &&
        !!atcb_validate_created(e, a) &&
        !!atcb_validate_updated(e, a) &&
        !!atcb_validate_options(e, a) &&
        !!atcb_validate_date_blocks(e, a) &&
        !!atcb_validate_rrule(e, a)
    );
}
function atcb_validate_icsFile(e, a, t = "", n = "") {
    t =
        "" != t && null != e.dates["" + t].icsFile
            ? e.dates["" + t].icsFile
            : "" == t && null != e.icsFile
            ? e.icsFile
            : "";
    return (
        !(
            "" != t &&
            (!atcb_secure_url(t, !1) ||
                (!/^https:\/\/(.)*\.ics$/m.test(e.icsFile) && !e.subscribe) ||
                (!e.icsFile.startsWith("https://") && e.subscribe))
        ) ||
        (console.error(a + " failed: explicit ics file path not valid" + n), !1)
    );
}
...
function atcb_validate_options(e, a) {
    return !!e.options.every(function (e) {
        return (
            !!atcbOptions.includes(e) ||
            (console.error(a + " failed: invalid option [" + e + "]"), !1)
        );
    });
}
...
function atcb_validate_status(e, a, t, n) {
    return (
        "TENTATIVE" == e.dates["" + t].status ||
        "CONFIRMED" == e.dates["" + t].status ||
...
function atcb_validate_availability(e, a, t, n) {
    return (
        ...
        (console.error(
            a + ' failed: event availability needs to be "free" or "busy"' + n
        ),
        !1)
    );
}
...
function atcb_validate_timezone(e, a, t, n) {
    if (
        ...
        "" != e.dates["" + t].timeZone &&
        !tzlib_get_timezones().includes(e.dates["" + t].timeZone)
    )
        return console.error(a + " failed: invalid time zone given" + n), !1;
    return !0;
}
    ...
    return (
        !!e.every(function (e) {
            ...
            return 10 !== t.dates["" + o]["" + e].length
                ? (console.error(
                      n + " failed: date misspelled [-> YYYY-MM-DD]" + i
                  ),
                  !1)
                : (a = t.dates["" + o]["" + e].split("-")).length < 3 ||
                  3 < a.length
                ? (console.error(
                      n +
        ...
        !!["startTime", "endTime"].every(function (e) {
            if (null != t.dates["" + o]["" + e]) {
                if (5 !== t.dates["" + o]["" + e].length)
                    return (
                        console.error(
                            n + " failed: time misspelled [-> HH:MM]" + i
                        ),
                        !1
                    );
                ...
                "startTime" == e &&
                    (l.startDate = new Date(
                        l.startDate.getTime() + 36e5 * a[0] + 6e4 * a[1]
                    )),
                    "endTime" == e &&
                        (l.endDate = new Date(
                            l.endDate.getTime() + 36e5 * a[0] + 6e4 * a[1]
                        ));
            }
            return !0;
        }) &&
        ((null != t.dates["" + o].startTime &&
            null == t.dates["" + o].endTime) ||
        (null == t.dates["" + o].startTime && null != t.dates["" + o].endTime)
            ? (console.error(
                  n +
                      " failed: if you set a starting time, you also need to define an end time" +
                      i
              ),
              !1)
            : !(l.endDate < l.startDate) ||
              (console.error(n + " failed: end date before start date" + i),
              !1))
    );
}
function atcb_validate_rrule(e, a) {
    return null != e.recurrence && "" != e.recurrence && 1 < e.dates.length
        ? (console.error(
              a + " failed: RRULE and multi-date set at the same time"
          ),
          !1)
        : null == e.recurrence ||
          "" == e.recurrence ||
                  ...
                  /^\d+$/.test(e.recurrence_count)
                    ? null == e.recurrence_byMonth ||
                      ...
                      /^(\d|,)+$/.test(e.recurrence_byMonth)
                          ...
                          /^(\d|,)+$/.test(e.recurrence_byMonthDay)
                            ? null == e.recurrence_byDay ||
                              ...
                              /^(\d|-|MO|TU|WE|TH|FR|SA|SU|,)+$/im.test(
                                ...
                                : (console.error(
                                      a +
                                          " failed: recurrence data (byDay) misspelled"
                                  ),
                                  !1)
                            : (console.error(
                                  a +
                        ...
                        : (console.error(
                              a +
                                  " failed: recurrence data (byMonth) misspelled"
                          ),
                          !1)
                    : (console.error(
                          a + " failed: recurrence data (interval) misspelled"
                      ),
                      !1)
                : (console.error(
                      a + " failed: recurrence data (until) misspelled"
                  ),
                  !1)
            : (console.error(
                  a + " failed: recurrence data (interval) misspelled"
                ...
                ? (a.classList.add("atcb-active"),
                  "modal" === e.listStyle
                      ...
                      : (l.appendChild(o),
                        ...
                        e.mindScrolling &&
                            l.classList.add("atcb-mind-scrolling")),
                  n && o.classList.add("atcb-generated-button"))
                : o.classList.add("atcb-modal");
        var i,
            n = atcb_generate_bg_overlay(
                e.listStyle,
                e.trigger,
                e.lightMode,
                e.background
              ...
              setTimeout(function () {
                  (l.style.display = "block"),
                      "dropdown-static" === e.listStyle
                          ? atcb_position_list(a, l, !0)
                          : atcb_position_list(a, l);
              }, 5)),
            atcb_set_fullsize(n),
            t
                ? o.firstChild.focus()
                : o.firstChild.focus({ preventScroll: !0 }),
            o.firstChild.blur();
    }
}
function atcb_close(a = !1) {
    ...
    if (1 < t.length) {
        document
            .querySelectorAll(
                '.atcb-modal[data-modal-nr="' + t.length + '"]'
            )[0]
            .remove();
        t = document.querySelectorAll(
            '.atcb-modal[data-modal-nr="' + (t.length - 1) + '"]'
        )[0];
        ...
        t && (t.focus({ preventScroll: !0 }), a || t.blur()),
            Array.from(document.querySelectorAll(".atcb-active")).forEach(
                (e) => {
            ...
            Array.from(document.querySelectorAll(".atcb-list-wrapper"))
                ...
                .concat(
                    Array.from(
                        document.querySelectorAll(".atcb-modal[data-modal-nr]")
                    )
                )
                .concat(
                    Array.from(
                        document.querySelectorAll(
                            "#add-to-calendar-button-reference"
                        )
                    )
                )
                .concat(
                    Array.from(document.querySelectorAll("#atcb-pos-wrapper"))
                )
                .concat(
                    Array.from(document.querySelectorAll("#atcb-bgoverlay"))
                )
                .forEach((e) => e.remove());
    }
}
        ...
        default:
            (t.id = a.identifier),
                ...
                t.addEventListener("keyup", function (e) {
                    "Enter" == e.key &&
                        (e.preventDefault(), atcb_toggle("auto", a, t, !0, !0));
                });
            break;
        case "apple":
        case "google":
...
function atcb_generate_label_content(e, a, t, n, o, i) {
    ...
    ("date" == e.buttonStyle && ("trigger" == t || i)) ||
        (n &&
            ((i = document.createElement("span")).classList.add("atcb-icon"),
            (i.innerHTML = atcbIcon["" + t]),
            a.appendChild(i)),
        (("trigger" == t && 1 == e.textLabelButton) ||
            ("trigger" != t && 1 == e.textLabelList)) &&
            ((n = document.createElement("span")).classList.add("atcb-text"),
            (n.textContent = o),
            a.appendChild(n)));
}
function atcb_generate_button(e, a) {
    (e.textContent = ""),
        a.richData &&
            ...
            a.dates[0].location &&
            a.dates[0].startDate &&
            atcb_generate_rich_data(a, e);
    var t = document.createElement("div"),
        n =
            (t.classList.add("atcb-button-wrapper"),
    ...
    n.classList.add("atcb-button"),
        ...
        1 === a.options.length
            ...
            : (atcb_generate_label(a, n, "trigger", a.iconButton, a.label),
...
function atcb_generate_rich_data(a, e) {
    var t,
        ...
        i =
            (1 < a.dates.length &&
                ((t = []).push('"@context":"https://schema.org"'),
    ...
    for (let e = 0; e < a.dates.length; e++) {
        var l = [],
            ...
            s =
                ...
                null != a.recurrence && "" != a.recurrence
                    ? l.push(...atcb_generate_rich_data_recurrence(a, r))
                    : l.push('"endDate":"' + r.end + '"'),
                null != a.dates["" + e].organizer &&
                    "" != a.dates["" + e].organizer &&
                    ((r = a.dates["" + e].organizer.split("|")),
                    l.push(
                        '"organizer":{\r\n"@type":"Person",\r\n"name":"' +
                            r[0] +
                            '",\r\n"email":"' +
        ...
        if (null != a.images) {
            if (Array.isArray(a.images))
                for (let e = 0; e < a.images.length; e++)
                    atcb_secure_url(a.images["" + e]) &&
                        a.images["" + e].startsWith("http") &&
                        s.push('"' + a.images["" + e] + '"');
        } else
            s.push(
...
function atcb_generate_rich_data_recurrence(e, a) {
    var t = [],
        n =
            ...
            null != e.dates[0].timeZone &&
                "" != e.dates[0].timeZone &&
                t.push('"scheduleTimezone":"' + e.dates[0].timeZone + '"'),
    ...
    return (
        ...
        null != e.recurrence_byMonth &&
            "" != e.recurrence_byMonth &&
            ((n = e.recurrence_byMonth.includes(",")
                ? "[" + e.recurrence_byMonth + "]"
                : e.recurrence_byMonth),
            t.push('"byMonth":"' + n + '"')),
        null != e.recurrence_byMonthDay &&
            "" != e.recurrence_byMonthDay &&
            ((n = e.recurrence_byMonthDay.includes(",")
                ? "[" + e.recurrence_byMonthDay + "]"
                : e.recurrence_byMonthDay),
            t.push('"byMonthDay":"' + n + '"')),
        null != e.recurrence_count &&
            "" != e.recurrence_count &&
            t.push('"repeatCount":"' + e.recurrence_count + '"'),
        null != e.recurrence_until &&
            "" != e.recurrence_until &&
            t.push('"endDate":"' + e.recurrence_until + '"'),
        null != e.startTime &&
            "" != e.startTime &&
            null != e.endTime &&
            "" != e.endTime &&
            (t.push('"startTime":"' + e.startTime + ':00"'),
...
function atcb_create_modal(n, e = "", a, t = "", o = [], i = [], l = !1) {
    var r =
            document.getElementById("atcb-bgoverlay") ||
        ...
        s =
            (r.classList.add("atcb-no-animation"),
            document.body.appendChild(r),
            document.createElement("div")),
        c =
            (s.classList.add("atcb-modal"),
            r.appendChild(s),
        ...
        d =
            (null != d && d.classList.add("atcb-active-modal"),
            document.createElement("div")),
        e =
            ...
            document.createElement("div"));
    if (
        (e.classList.add("atcb-modal-headline"),
        (e.textContent = a),
        d.appendChild(e),
        "" != t &&
            ((r = document.createElement("div")).classList.add(
        ...
        for (let e = 1; e < i.length; e++) {
            ...
            switch (
                ...
                0 < atcbStates["" + n.identifier]["" + i[0]][e - 1] &&
                    m.classList.add("atcb-saved"),
    ...
    0 == o.length &&
        o.push({ type: "close", label: atcb_translate_hook("Close", n) });
        ...
        o.forEach((e, a) => {
            ...
            switch (
                ...
                (null != e.label && "" != e.label) ||
                    (e.label = atcb_translate_hook("Click me", n)),
    ...
    var a = (function () {
            let e,
                ...
                l =
                    ((n =
                        "all" == m
                            ? ((o = atcb_generate_time(u.dates[0])),
                              (i = atcb_generate_time(
                                  u.dates[u.dates.length - 1]
                              )),
                              (t = u.dates[0].timeZone),
                              u.dates[u.dates.length - 1].timeZone)
                            : ((o = atcb_generate_time(u.dates["" + m])),
                              (i = o),
                ...
                s = "";
            o.allday ||
                Intl.DateTimeFormat().resolvedOptions().timeZone == t ||
                t == n ||
                (r = " (" + t + ")"),
                ((i.allday ||
                    Intl.DateTimeFormat().resolvedOptions().timeZone == n) &&
                    t == n) ||
                    (s = " (" + n + ")");
            ...
            return (
                ...
                e.getDate() === a.getDate()
                    ? (l = o.allday
                          ? e.toLocaleDateString(u.language, c.DateShort)
                          : e.toLocaleString(u.language, c.DateTimeShort) +
                            r +
                            " - " +
                            a.toLocaleTimeString(u.language, d.Time) +
                            s)
                    : ((l = o.allday
                          ? e.toLocaleDateString(u.language, c.DateShort)
                          : e.toLocaleString(u.language, c.DateTimeShort)),
                      (l += r + " - "),
                      i.allday
                          ? (l += a.toLocaleDateString(u.language, d.DateLong))
                          : (l += a.toLocaleString(u.language, d.DateTimeLong)),
                      (l += s)),
                l
            );
        })(),
        t =
            "all" != m && "CANCELLED" == u.dates["" + m].status
                ? atcb_translate_hook("Cancelled Date", u) +
                  "<br>" +
                  atcb_translate_hook("Delete from Calendar", u)
                : "+ " + atcb_translate_hook("Add to Calendar", u),
        n =
            "all" != m && "CANCELLED" == u.dates["" + m].status
                ? atcb_translate_hook("Cancelled Date", u)
                : "",
        ...
        i =
            null != u.dates["" + m].timeZone && "" != u.dates["" + m].timeZone
                ? u.dates["" + m].timeZone
                : "UTC",
        ...
        r =
            ...
            document.createElement("div")),
        s =
            (r.classList.add("atcb-date-btn-day"),
            l.appendChild(r),
            document.createElement("div")),
        r =
            ...
            document.createElement("div")),
        o =
            (r.classList.add("atcb-date-btn-right"),
            e.appendChild(r),
            document.createElement("div")),
        i =
            (o.classList.add("atcb-date-btn-details"),
            r.appendChild(o),
            document.createElement("div")),
        n =
            ...
            document.createElement("div")),
        s =
            (n.classList.add("atcb-date-btn-content"),
            o.appendChild(n),
            document.createElement("span")),
        l =
            (s.classList.add("atcb-date-btn-content-icon"),
...
function atcb_generate_links(e, a, t = "all", n = !1, o = !1) {
    if (
        ("all" != t ? (t = parseInt(t) - 1) : 1 == a.dates.length && (t = 0),
        a.subscribe)
    )
        atcb_generate_subscribe_links(e, a, n);
    else if (
        (!isMobile() ||
            ("msteams" != e && "ms365" != e && "outlookcom" != e) ||
            (e = "ical"),
        "all" != t)
    ) {
        if (
            "CANCELLED" == a.dates["" + t].status &&
            "apple" != e &&
            "ical" != e
        )
            atcb_create_modal(
                a,
                "warning",
                atcb_translate_hook("Cancelled Date", a),
                atcb_translate_hook("Delete from Calendar", a),
                [],
                [],
                n
            );
    ...
    if (
        ...
        if (!n) {
            ...
            atcb_create_modal(
                t,
                a,
                atcb_translate_hook("modal.multidate.h", t),
                atcb_translate_hook("modal.multidate.text", t),
                [],
                o,
                e
            );
...
function atcb_generate_subscribe_links(e, a, t) {
    ...
    switch (e) {
        ...
        case "ical":
            ...
            break;
        case "google":
            atcb_subscribe_google(
                n.replace("webcal://calendar.google.com/calendar/u/2?cid=", "")
            );
            break;
        case "ms365":
        ...
        case "yahoo":
            return (
                ...
                void atcb_create_modal(
                    ...
                    atcb_translate_hook("modal.clipboard.text", a) +
                        "<br>" +
                        atcb_translate_hook("modal.subscribe.yahoo.text", a),
                    [
                        {
                            label: atcb_translate_hook(
                                "Open Yahoo Calendar",
                                a
                            ),
                            primary: !0,
...
function atcb_set_fully_successful(e, a) {
    ...
    e && e.classList.add("atcb-saved"),
        atcb_saved_hook(),
        a &&
            document.querySelectorAll(".atcb-modal[data-modal-nr]").length <
                2 &&
            atcb_toggle("close");
}
...
function atcb_generate_google(e) {
    var a = [],
        ...
        t =
            (a.push(
                "dates=" +
                    encodeURIComponent(t.start) +
                    "%2F" +
                    encodeURIComponent(t.end)
            ),
            null == e.timeZone ||
                "" == e.timeZone ||
            ...
            null != e.name &&
                "" != e.name &&
                a.push("text=" + encodeURIComponent(e.name)),
            []);
    null != e.description && "" != e.description && t.push(e.description),
        null != e.location &&
            ...
            isiOS() &&
                (0 < t.length && t.push("<br><br>"),
                t.push("&#128205;: " + e.location))),
        0 < t.length && a.push("details=" + encodeURIComponent(t.join())),
        null != e.recurrence &&
            "" != e.recurrence &&
            a.push("recur=" + encodeURIComponent(e.recurrence)),
        null != e.availability &&
            "" != e.availability &&
            ((t =
                "free" == e.availability
...
function atcb_generate_yahoo(e) {
    ...
    a.push(
        ...
        null != e.name &&
            "" != e.name &&
            a.push("title=" + encodeURIComponent(e.name)),
        null != e.location &&
            "" != e.location &&
            a.push("in_loc=" + encodeURIComponent(e.location)),
        null != e.descriptionHtmlFree &&
            "" != e.descriptionHtmlFree &&
            a.push("desc=" + encodeURIComponent(e.descriptionHtmlFree)),
        atcb_open_cal_url(a.join("&"));
}
function atcb_generate_microsoft(e, a = "365") {
    ...
    t.push("startdt=" + encodeURIComponent(a.start)),
        ...
        null != e.name &&
            "" != e.name &&
            t.push("subject=" + encodeURIComponent(e.name)),
        null != e.location &&
            "" != e.location &&
        ...
        null != e.description &&
            ...
            t.push(
                "body=" +
                    encodeURIComponent(e.description.replace(/\n/g, "<br>"))
            ),
...
function atcb_generate_msteams(e) {
    ...
    a.push("startTime=" + encodeURIComponent(t.start)),
        ...
        null != e.name &&
            "" != e.name &&
            a.push("subject=" + encodeURIComponent(e.name));
    let n = "";
    null != e.location &&
        "" != e.location &&
        ...
        null != e.descriptionHtmlFree &&
            "" != e.descriptionHtmlFree &&
            a.push("content=" + n + encodeURIComponent(e.descriptionHtmlFree)),
        a.push("uid=" + encodeURIComponent(e.uid)),
        atcb_open_cal_url(
            "https://teams.microsoft.com/l/meeting/new?" + a.join("&")
        );
}
...
function atcb_generate_ical(a, e = "all", t = !1) {
    ...
    const o =
        "all" != e &&
        null != a.dates["" + e].icsFile &&
        "" != a.dates["" + e].icsFile
            ? a.dates["" + e].icsFile
            : null != a.icsFile && "" != a.icsFile
            ? a.icsFile
            : "";
    if ("" == o || (isiOS() && isWebView())) {
        ...
        for (let e = l; e <= r; e++) {
            ...
            c.push("BEGIN:VEVENT"),
                ...
                c.push(
                    "SUMMARY:" +
                        a.dates["" + e].name.replace(/.{65}/g, "$&\r\n ")
                ),
                null != a.dates["" + e].descriptionHtmlFree &&
                    "" != a.dates["" + e].descriptionHtmlFree &&
                    c.push(
                        "DESCRIPTION:" +
                            a.dates["" + e].descriptionHtmlFree
    ...
    atcb_copy_to_clipboard(e),
        isiOS() && isChrome()
            ? atcb_create_modal(
                  ...
                  atcb_translate_hook("modal.crios.ical.text", a) +
                      "<br>" +
                      atcb_translate_hook("modal.clipboard.text", a) +
                      "<br>" +
                      atcb_translate_hook("modal.crios.ical.steps", a),
                  [],
                  [],
                  t
              )
            : atcb_create_modal(
                  ...
                  atcb_translate_hook("modal.webview.ical.text", a) +
                      "<br>" +
                      atcb_translate_hook("modal.clipboard.text", a) +
                      "<br>" +
                      atcb_translate_hook("modal.webview.ical.steps", a),
                  [],
                  [],
                  t
              );
        ...
        );
    {
        ...
        l =
            s < 10
                ...
                : s + ":" + ("0" + c).slice(-2);
        if (
            (null == e.timeZone || (null != e.timeZone && "" == e.timeZone)) &&
            n
        )
            return {
        ...
        if (null != e.timeZone && "" != e.timeZone) {
            ...
            var n =
                    ...
                    parseInt(t[0] + 1) *
                    (60 *
                        (60 * parseInt(t.substr(1, 2)) +
                            parseInt(t.substr(3, 2))) *
                        1e3),
                r =
                    -1 *
                    parseInt(e[0] + 1) *
                    (60 *
                        (60 * parseInt(e.substr(1, 2)) +
                            parseInt(e.substr(3, 2))) *
                        1e3);
...
function atcb_format_datetime(e, a = "delimiters", t = !0, n = !1) {
    t = t
        ...
        : /T(\d{2}:\d{2}:\d{2}\.\d{3})Z/g;
    return n
        ? e.toISOString().replace(t, "").replace("Z", "")
...
function atcb_validEmail(e, a = !1) {
    return (
        !!/^.{0,70}@.{1,30}\.[\w.]{2,9}$/.test(e) &&
        (a && console.log("Testing for MX records not yet available"), !0)
    );
}
...
function atcb_position_list(e, a, t = !1, n = !1) {
    ...
    var s = i.getBoundingClientRect(),
        ...
        d =
            ...
            !0 !== o || a.classList.contains("atcb-dropoverlay")
                ? ((a.style.minWidth = s.width + 20 + "px"),
                  (r = a.getBoundingClientRect()),
                  (a.style.top =
                      window.scrollY +
                      s.top +
                      ...
                      r.height / 2 +
                      "px"),
                  (a.style.left = s.left - (r.width - s.width) / 2 + "px"))
                : ((a.classList.contains("atcb-dropup") && n) ||
                  (!t &&
                      !n &&
                      l.top + r.height > c - 20 &&
                      20 < 2 * s.top + s.height - l.top - r.height)
                      ? (i.classList.add("atcb-dropup"),
                        a.classList.add("atcb-dropup"),
                        (a.style.bottom =
                            2 * c -
                            (c + (s.top + (s.top + s.height - l.top))) -
                            window.scrollY +
                            "px"))
                      : ((a.style.top = window.scrollY + l.top + "px"),
                        i.classList.contains("atcb-dropup") &&
                            i.classList.remove("atcb-dropup")),
                  (l = e.getBoundingClientRect()),
                  a.classList.contains("atcb-style-bubble") ||
    ...
    d &&
        (i.classList.contains("atcb-dropup")
            ? ((d.style.top = window.scrollY + s.top + s.height + "px"),
              (d.style.left = s.left + (s.width - 150) / 2 + "px"))
            : ((r = a.getBoundingClientRect()),
              i.classList.contains("atcb-dropoverlay") || !o
                  ? (d.style.top = window.scrollY + r.top + r.height + "px")
                  : (d.style.top = window.scrollY + l.top + r.height + "px"),
...
function atcb_manage_body_scroll(e = null) {
    e =
        null != e
            ? e
            : 0 == (e = document.querySelectorAll(".atcb-modal")).length
            ? null
            : e[e.length - 1];
    null != e &&
        (e.getBoundingClientRect().height + 100 > window.innerHeight
...
function atcb_copy_to_clipboard(e) {
    ...
    (n.value = e),
        ...
        (n.readOnly = !1),
        isiOS()
            ? ((a = document.createRange()).selectNodeContents(n),
...
const i18nStrings = {
    ...
    de: {
        ...
        "modal.webview.ical.steps":
            "<ol><li><strong>Ã–ffne einen anderen Browser</strong> auf deinem Smartphone, ...</li><li>Nutze die <strong>EinfÃ¼gen</strong>-Funktion, um fortzufahren.</li></ol>",
        "modal.crios.ical.h": "Ã–ffne Safari",
        "modal.crios.ical.text":
            "Leider Chrome unter iOS Probleme mit der Art, wie wir Kalender-Dateien erzeugen.",
        "modal.crios.ical.steps":
            "<ol><li><strong>Ã–ffne Safari</strong>, ...</li><li>Nutze die <strong>EinfÃ¼gen</strong>-Funktion, um fortzufahren.</li></ol>",
        "modal.multidate.h": "Dies is eine Termin-Reihe",
        "modal.multidate.text":
            "FÃ¼ge die einzelnen Termine der Reihe nach deinem Kalender hinzu:",
        Event: "Termin",
        ...
        "modal.subscribe.yahoo.text":
            '<ol><li>Ã–ffne den Yahoo Kalender.</li><li>Klicke auf den "Aktionen" Tab.</li><li>WÃ¤hle "Weiteren Kalendern folgen".</li><li>WÃ¤hle einen Namen und fÃ¼ge die URL aus deiner Zwischenablage in das URL-Feld ein.</li></ol>',
        Cancel: "Abbrechen",
    },
    es: {
        ...
        "modal.clipboard.text":
            "Hemos copiado automÃ¡ticamente una URL mÃ¡gica en su portapapeles.",
        "modal.webview.ical.steps":
            "<ol><li><strong>Abre otro browser</strong> en tu smartphone, ...</li><li>Utilice la funciÃ³n de <strong>pegar</strong> para continuar.</li></ol>",
        ...
        "modal.crios.ical.steps":
            "<ol><li><strong>Abrir Safari</strong>, ...</li><li>Utilice la funciÃ³n de <strong>pegar</strong> para continuar.</li></ol>",
        "modal.multidate.h": "Esta es una serie de fechas",
        "modal.multidate.text":
            "AÃ±ada las fechas individuales a su calendario en orden:",
        Event: "TÃ©rmino",
        ...
        "modal.subscribe.yahoo.text":
            '<ol><li>Abra el calendario de Yahoo.</li><li>Haga clic en la pestaÃ±a "Acciones".</li><li>Seleccione "Seguir otros calendarios".</li><li>Elige un nombre y pega la URL de tu portapapeles en el campo URL.</li></ol>',
        Cancel: "Cancelar",
    },
    pt: {
        ...
        "modal.webview.ical.text":
            "Infelizmente, os navegadores em tampas tÃªm problemas com a forma como geramos o ficheiro de calendÃ¡rio.",
        "modal.clipboard.text":
            "CopiÃ¡mos automaticamente um URL mÃ¡gico para a sua Ã¡rea de transferÃªncia.",
        "modal.webview.ical.steps":
            "<ol><li><strong>Abrir outro browser</strong> en tu smartphone, ...</li><li>Use a funÃ§Ã£o <forte>colar</strong> para continuar.</li></ol>",
        "modal.crios.ical.h": "Safari aberto",
        "modal.crios.ical.text":
            "Infelizmente, o cromado no iOS tem problemas com a forma como geramos o ficheiro do calendÃ¡rio.",
        "modal.crios.ical.steps":
            "<ol><li><strong>Safari aberto</strong>, ...</li><li>Use a funÃ§Ã£o <forte>colar</strong> para continuar.</li></ol>",
        "modal.multidate.h": "Esta Ã© uma sÃ©rie de datas",
        "modal.multidate.text":
            "Adicione as datas individuais ao seu calendÃ¡rio, por ordem:",
        Event: "Termo",
        ...
        "modal.subscribe.yahoo.text":
            '<ol><li>Abrir o calendÃ¡rio do Yahoo.</li><li>Clique no separador "AcÃ§Ãµes".</li><li>Seleccione "Seguir outros calendÃ¡rios".</li><li>Escolha um nome e cole o URL da sua Ã¡rea de transferÃªncia no campo URL.</li></ol>',
        Cancel: "Cancelar",
    },
    fr: {
        ...
        "modal.webview.ical.text":
            "Malheureusement, les navigateurs in-app ont des problÃ¨mes avec la maniÃ¨re dont nous crÃ©ons les fichiers de agenda.",
        "modal.clipboard.text":
            "Nous avons automatiquement copiÃ© une URL magique dans ton presse-papiers.",
        "modal.webview.ical.steps":
            "<ol><li><strong>Ouvre un autre navigateur</strong> sur ton smartphone, ...</li><li>Utilise la fonction <strong>insÃ©rer</strong> pour continuer.</li></ol>",
        "modal.crios.ical.h": "Ouvre Safari",
        "modal.crios.ical.text":
            "Malheureusement, Chrome sur iOS a des problÃ¨mes avec la faÃ§on dont nous gÃ©nÃ©rons le fichier du agenda.",
        "modal.crios.ical.steps":
            "<ol><li><strong>Ouvre Safari</strong>, ...</li><li>Utilise la fonction <strong>insÃ©rer</strong> pour continuer.</li></ol>",
        "modal.multidate.h": "Il s'agit d'une sÃ©rie d'Ã©vÃ©nements",
        "modal.multidate.text":
            "Ajoute les diffÃ©rents rendez-vous dans l'ordre Ã  ton agenda:",
        Event: "Terminaison",
        ...
        "modal.subscribe.yahoo.text":
            '<ol><li>Ouvre le Yahoo calendar.</li><li>Clique sur l\'onglet "Actions".</li><li>SÃ©lectionne "Suivre d\'autres agendas".</li><li>Choisis un nom et colle l\'URL de ton presse-papiers dans le champ URL.</li></ol>',
        Cancel: "Annuler",
    },
    nl: {
        ...
        "modal.multidate.text":
            "Voeg de afzonderlijke delen Ã©Ã©n voor Ã©Ã©n toe:",
        Event: "Termin",
    ...
    tr: {
        ...
        "modal.webview.ical.text":
            "Ne yazÄ±k ki, uygulama iÃ§i tarayÄ±cÄ±lar takvim dosyalarÄ±nÄ± oluÅŸturma ÅŸeklimizle ilgili sorunlar yaÅŸÄ±yor.",
        "modal.clipboard.text":
            "Panonuza otomatik olarak sihirli bir URL kopyaladÄ±k.",
        "modal.webview.ical.steps":
            "<ol><li><strong>AkÄ±llÄ± telefonunuzda baÅŸka bir tarayÄ±cÄ± aÃ§Ä±n</strong>, ...</li><li>Devam etmek iÃ§in <strong>insert</strong> fonksiyonunu kullanÄ±n.</li></ol>",
        "modal.crios.ical.h": "AÃ§Ä±k Safari",
        "modal.crios.ical.text":
            "Ne yazÄ±k ki iOS'ta Chrome'un takvim dosyasÄ± oluÅŸturma yÃ¶ntemiyle ilgili sorunlarÄ± var.",
        "modal.crios.ical.steps":
            "<ol><li><strong>AÃ§Ä±k Safari</strong>, ...</li><li>Devam etmek iÃ§in <strong>insert</strong> fonksiyonunu kullanÄ±n.</li></ol>",
        ...
        "modal.subscribe.yahoo.text":
            '<ol><li>Yahoo takvimini aÃ§Ä±n.</li><li>"Eylemler" sekmesine tÄ±klayÄ±n.</li><li>"DiÄŸer Takvimleri Takip Et" Ã¶ÄŸesini seÃ§in.</li><li>Bir ad seÃ§in ve URL\'yi panonuzdan URL alanÄ±na yapÄ±ÅŸtÄ±rÄ±n.</li></ol>',
        Cancel: "Ä°ptal",
    },
    zh: {
        ...
        "modal.webview.ical.text":
            "ä¸å¹¸çš„æ˜¯ï¼Œåº”ç”¨å†…æµè§ˆå™¨åœ¨æˆ‘ä»¬ç”Ÿæˆæ—¥åŽ†æ–‡ä»¶çš„æ–¹å¼ä¸Šå­˜åœ¨é—®é¢˜ã€‚",
        "modal.clipboard.text":
            "æˆ‘ä»¬è‡ªåŠ¨å°†é­”æœ¯ URL å¤åˆ¶åˆ°æ‚¨çš„å‰ªè´´æ¿ã€‚",
        "modal.webview.ical.steps":
            "<ol><li>æ‰“å¼€æ‰‹æœºä¸Šçš„ä»»ä½•å…¶ä»–æµè§ˆå™¨, ...</li><li>ç²˜è´´å‰ªè´´æ¿å†…å®¹å¹¶å¼€å§‹ã€‚</li></ol>",
        "modal.crios.ical.h": "æ‰“å¼€ Safari",
        "modal.crios.ical.text":
            "ä¸å¹¸çš„æ˜¯ï¼ŒiOS ä¸Šçš„ Chrome åœ¨æˆ‘ä»¬ç”Ÿæˆæ—¥åŽ†æ–‡ä»¶çš„æ–¹å¼ä¸Šå­˜åœ¨é—®é¢˜ã€‚",
        "modal.crios.ical.steps":
            "<ol><li><strong>æ‰“å¼€ Safari</strong>, ...</li><li>ç²˜è´´å‰ªè´´æ¿å†…å®¹å¹¶å¼€å§‹ã€‚</li></ol>",
        ...
        "modal.subscribe.yahoo.text":
            "<ol><li>æ‰“å¼€ Yahoo æ—¥åŽ†ã€‚</li><li>ç‚¹å‡»â€œæ“ä½œâ€æ ‡ç­¾ã€‚</li><li>é€‰æ‹©â€œå…³æ³¨å…¶ä»–æ—¥åŽ†â€ã€‚</li><li>é€‰æ‹©ä¸€ä¸ªåç§°å¹¶å°†å‰ªè´´æ¿ä¸­çš„ URL ç²˜è´´åˆ° URL å­—æ®µä¸­ã€‚</li></ol>",
        Cancel: "ä¸­æ­¢",
    },
    ar: {
        ...
        "modal.webview.ical.text":
            "Ù„Ø³ÙˆØ¡ Ø§Ù„Ø­Ø¸ ØŒ ØªÙˆØ§Ø¬Ù‡ Ø§Ù„Ù…ØªØµÙØ­Ø§Øª Ø¯Ø§Ø®Ù„ Ø§Ù„ØªØ·Ø¨ÙŠÙ‚ Ù…Ø´Ø§ÙƒÙ„ ÙÙŠ Ø·Ø±ÙŠÙ‚Ø© Ø¥Ù†Ø´Ø§Ø¡ Ù…Ù„Ù Ø§Ù„ØªÙ‚ÙˆÙŠÙ….",
        "modal.clipboard.text":
            "Ù‚Ù…Ù†Ø§ ØªÙ„Ù‚Ø§Ø¦ÙŠÙ‹Ø§ Ø¨Ù†Ø³Ø® Ø¹Ù†ÙˆØ§Ù† URL Ø³Ø­Ø±ÙŠ Ø¥Ù„Ù‰ Ø§Ù„Ø­Ø§ÙØ¸Ø© Ø§Ù„Ø®Ø§ØµØ© Ø¨Ùƒ.",
        "modal.webview.ical.steps":
            "<ol><li>Ø§ÙØªØ­ Ø£ÙŠ Ù…ØªØµÙØ­ Ø¢Ø®Ø± Ø¹Ù„Ù‰ Ù‡Ø§ØªÙÙƒ Ø§Ù„Ø°ÙƒÙŠ, ...</li><li>.Ø§Ù„ØµÙ‚ Ù…Ø­ØªÙˆÙ‰ Ø§Ù„Ø­Ø§ÙØ¸Ø© ÙˆØ§Ø°Ù‡Ø¨</li></ol>",
        "modal.crios.ical.h": "Ø§ÙØªØ­ Safari",
        "modal.crios.ical.text":
            "Ù„Ø³ÙˆØ¡ Ø§Ù„Ø­Ø¸ ØŒ ÙŠÙˆØ§Ø¬Ù‡ Chrome Ø¹Ù„Ù‰ iOS Ù…Ø´Ø§ÙƒÙ„ ÙÙŠ Ø·Ø±ÙŠÙ‚Ø© Ø¥Ù†Ø´Ø§Ø¡ Ù…Ù„Ù Ø§Ù„ØªÙ‚ÙˆÙŠÙ…",
        "modal.crios.ical.steps":
            "<ol><li><strong>Ø§ÙØªØ­ Safari</strong>, ...</li><li>Ø§Ù„ØµÙ‚ Ù…Ø­ØªÙˆÙ‰ Ø§Ù„Ø­Ø§ÙØ¸Ø© ÙˆØ§Ø°Ù‡Ø¨.</li></ol>",
        "modal.multidate.h": "Ù‡Ø°Ù‡ Ø³Ù„Ø³Ù„Ø© Ø£Ø­Ø¯Ø§Ø«",
        "modal.multidate.text":
            "Ø£Ø¶Ù Ø§Ù„Ø£Ø¬Ø²Ø§Ø¡ Ø§Ù„ÙØ±Ø¯ÙŠØ© ÙˆØ§Ø­Ø¯Ø© ØªÙ„Ùˆ Ø§Ù„Ø£Ø®Ø±Ù‰:",
        Event: "Ø­Ø¯Ø«",
        "Cancelled Date": "ØªÙ… Ø¥Ù„ØºØ§Ø¡ Ù‡Ø°Ø§ Ø§Ù„ØªØ§Ø±ÙŠØ®.",
        "Delete from Calendar":
            "Ø§Ù„Ø±Ø¬Ø§Ø¡ ØªØ­Ø¯ÙŠØ« Ø§Ù„ØªÙ‚ÙˆÙŠÙ… Ø§Ù„Ø®Ø§Øµ Ø¨Ùƒ!",
        "modal.subscribe.yahoo.h": "Ø£Ø¶Ù Ø§Ù„ØªÙ‚ÙˆÙŠÙ… Ø¥Ù„Ù‰ Yahoo",
        "modal.subscribe.yahoo.text":
            '<ol><li>Ø§ÙØªØ­ ØªÙ‚ÙˆÙŠÙ… Yahoo.</li><li>Ø§Ù†Ù‚Ø± ÙÙˆÙ‚ Ø¹Ù„Ø§Ù…Ø© Ø§Ù„ØªØ¨ÙˆÙŠØ¨ "Ø§Ù„Ø¥Ø¬Ø±Ø§Ø¡Ø§Øª".</li><li>Ø­Ø¯Ø¯ "Ù…ØªØ§Ø¨Ø¹Ø© ØªÙ‚ÙˆÙŠÙ…Ø§Øª Ø£Ø®Ø±Ù‰".</li><li>Ø§Ø®ØªØ± Ø§Ø³Ù…Ù‹Ø§ ÙˆØ§Ù„ØµÙ‚ Ø¹Ù†ÙˆØ§Ù† URL Ù…Ù† Ø§Ù„Ø­Ø§ÙØ¸Ø© Ø§Ù„Ø®Ø§ØµØ© Ø¨Ùƒ ÙÙŠ Ø­Ù‚Ù„ URL.</li></ol>',
        Cancel: "Ø¥Ø­Ø¨Ø§Ø·",
    },
    hi: {
        ...
        "modal.webview.ical.h":
            "à¤…à¤ªà¤¨à¤¾ à¤¬à¥à¤°à¤¾à¤‰à¤œà¤¼à¤° à¤–à¥‹à¤²à¥‡à¤‚",
        "modal.webview.ical.text":
            "à¤¦à¥à¤°à¥à¤­à¤¾à¤—à¥à¤¯ à¤¸à¥‡, à¤‡à¤¨-à¤à¤ª à¤¬à¥à¤°à¤¾à¤‰à¤œà¤¼à¤° à¤®à¥‡à¤‚ à¤•à¥ˆà¤²à¥‡à¤‚à¤¡à¤° à¤«à¤¼à¤¾à¤‡à¤² à¤¬à¤¨à¤¾à¤¨à¥‡ à¤•à¥‡ à¤¤à¤°à¥€à¤•à¥‡ à¤®à¥‡à¤‚ à¤¸à¤®à¤¸à¥à¤¯à¤¾à¤à¤ à¤¹à¥ˆà¤‚à¥¤",
        "modal.clipboard.text":
            "à¤¹à¤®à¤¨à¥‡ à¤†à¤ªà¤•à¥‡ à¤•à¥à¤²à¤¿à¤ªà¤¬à¥‹à¤°à¥à¤¡ à¤ªà¤° à¤¸à¥à¤µà¤šà¤¾à¤²à¤¿à¤¤ à¤°à¥‚à¤ª à¤¸à¥‡ à¤à¤• à¤œà¤¾à¤¦à¥à¤ˆ URL à¤•à¥‰à¤ªà¥€ à¤•à¤° à¤²à¤¿à¤¯à¤¾ à¤¹à¥ˆà¥¤",
        "modal.webview.ical.steps":
            "<ol><li>à¤…à¤ªà¤¨à¥‡ à¤«à¤¼à¥‹à¤¨ à¤ªà¤° <strong>à¤¦à¥‚à¤¸à¤°à¤¾ à¤¬à¥à¤°à¤¾à¤‰à¤œà¤¼à¤° à¤–à¥‹à¤²à¥‡à¤‚</strong>, ...</li><li>à¤•à¥à¤²à¤¿à¤ªà¤¬à¥‹à¤°à¥à¤¡ à¤¸à¤¾à¤®à¤—à¥à¤°à¥€ <strong>à¤šà¤¿à¤ªà¤•à¤¾à¤à¤‚</strong> à¤”à¤° à¤œà¤¾à¤à¤‚à¥¤</li></ol>",
        "modal.crios.ical.h": "à¤¸à¤«à¤¾à¤°à¥€ à¤–à¥‹à¤²à¥‡à¤‚",
        "modal.crios.ical.text":
            "à¤¦à¥à¤°à¥à¤­à¤¾à¤—à¥à¤¯ à¤¸à¥‡, iOS à¤ªà¤° Chrome à¤•à¥‹ à¤•à¥ˆà¤²à¥‡à¤‚à¤¡à¤° à¤«à¤¼à¤¾à¤‡à¤² à¤œà¥‡à¤¨à¤°à¥‡à¤Ÿ à¤•à¤°à¤¨à¥‡ à¤•à¥‡ à¤¹à¤®à¤¾à¤°à¥‡ à¤¤à¤°à¥€à¤•à¥‡ à¤®à¥‡à¤‚ à¤¸à¤®à¤¸à¥à¤¯à¤¾ à¤¹à¥ˆà¥¤",
        "modal.crios.ical.steps":
            "<ol><li><strong>à¤¸à¤«à¤¾à¤°à¥€ à¤–à¥‹à¤²à¥‡à¤‚</strong>, ...</li><li>à¤•à¥à¤²à¤¿à¤ªà¤¬à¥‹à¤°à¥à¤¡ à¤¸à¤¾à¤®à¤—à¥à¤°à¥€ <strong>à¤šà¤¿à¤ªà¤•à¤¾à¤à¤‚</strong> à¤”à¤° à¤œà¤¾à¤à¤‚à¥¤</li></ol>",
        "modal.multidate.h":
            "à¤¯à¤¹ à¤à¤• à¤‡à¤µà¥‡à¤‚à¤Ÿ à¤¸à¥€à¤°à¥€à¤œà¤¼ à¤¹à¥ˆ",
        "modal.multidate.text":
            "à¤…à¤²à¤—-à¤…à¤²à¤— à¤¹à¤¿à¤¸à¥à¤¸à¥‹à¤‚ à¤•à¥‹ à¤à¤•-à¤à¤• à¤•à¤°à¤•à¥‡ à¤œà¥‹à¤¡à¤¼à¥‡à¤‚:",
        Event: "à¤†à¤¯à¥‹à¤œà¤¨",
        "Cancelled Date": "à¤¯à¤¹ à¤¤à¤¿à¤¥à¤¿ à¤°à¤¦à¥à¤¦ à¤¹à¥‹ à¤—à¤ˆà¥¤",
        "Delete from Calendar":
            "à¤•à¥ƒà¤ªà¤¯à¤¾ à¤…à¤ªà¤¨à¤¾ à¤•à¥ˆà¤²à¥‡à¤‚à¤¡à¤° à¤…à¤ªà¤¡à¥‡à¤Ÿ à¤•à¤°à¥‡à¤‚!",
        "modal.subscribe.yahoo.h":
            "Yahoo . à¤®à¥‡à¤‚ à¤•à¥ˆà¤²à¥‡à¤‚à¤¡à¤° à¤œà¥‹à¤¡à¤¼à¥‡à¤‚",
        "modal.subscribe.yahoo.text":
            '<ol><li>Yahoo à¤•à¥ˆà¤²à¥‡à¤‚à¤¡à¤° à¤–à¥‹à¤²à¥‡à¤‚à¥¤</li><li>"à¤•à¥ƒà¤¤à¥€" à¤Ÿà¥ˆà¤¬ à¤ªà¤° à¤•à¥à¤²à¤¿à¤• à¤•à¤°à¥‡à¤‚à¥¤</li><li>"à¤‡à¤¤à¤° à¤•à¥…à¤²à¥‡à¤‚à¤¡à¤°à¥à¤¸à¤šà¥‡ à¤…à¤¨à¥à¤¸à¤°à¤£ à¤•à¤°à¤¾" à¤šà¥à¤¨à¥‡à¤‚à¥¤</li><li>à¤à¤• à¤¨à¤¾à¤® à¤šà¥à¤¨à¥‡à¤‚ à¤”à¤° à¤…à¤ªà¤¨à¥‡ à¤•à¥à¤²à¤¿à¤ªà¤¬à¥‹à¤°à¥à¤¡ à¤¸à¥‡ URL à¤•à¥‹ URL à¤«à¤¼à¥€à¤²à¥à¤¡ à¤®à¥‡à¤‚ à¤ªà¥‡à¤¸à¥à¤Ÿ à¤•à¤°à¥‡à¤‚à¥¤</li></ol>',
    ...
    pl: {
        ...
        "modal.webview.ical.text":
            "Niestety, przeglÄ…darki in-app majÄ… problemy ze sposobem, w jaki generujemy plik kalendarza.",
        "modal.clipboard.text":
            "Automatycznie skopiowaliÅ›my magiczny adres URL do schowka.",
        "modal.webview.ical.steps":
            "<ol><li><strong>OtwÃ³rz innÄ… przeglÄ…darkÄ™</strong> w swoim telefonie, ...</li><li><strong>Wklej</strong> zawartoÅ›Ä‡ schowka i ruszaj.</li></ol>",
        "modal.crios.ical.h": "OtwÃ³rz Safari",
        "modal.crios.ical.text":
            "Niestety, Chrome na iOS ma problemy ze sposobem generowania pliku kalendarza.",
        "modal.crios.ical.steps":
            "<ol><li><strong>OtwÃ³rz Safari</strong>, ...</li><li><strong>Wklej</strong> zawartoÅ›Ä‡ schowka i ruszaj.</li></ol>",
        ...
        "modal.subscribe.yahoo.text":
            '<ol><li>OtwÃ³rz kalendarz Yahoo.</li><li>Kliknij na zakÅ‚adkÄ™ "CzynnoÅ›ci".</li><li>Wybierz "Obserwuj inne kalendarze".</li><li>Wybierz nazwÄ™ i wklej adres URL ze schowka w polu URL.</li></ol>',
        Cancel: "Anuluj",
    },
    id: {
    ...
    no: {
        ...
        "modal.webview.ical.text":
            "Dessverre har nettlesere i appen problemer med mÃ¥ten vi genererer kalenderfilen pÃ¥.",
        "modal.clipboard.text":
            "Vi kopierte automatisk en magisk URL til utklippstavlen din.",
        "modal.webview.ical.steps":
            "<ol><li><strong>Ã…pne en annen nettleser</strong> pÃ¥ telefonen, ...</li><li><strong>Lim inn</strong> innholdet pÃ¥ utklippstavlen og gÃ¥.</li></ol>",
        "modal.crios.ical.h": "Ã…pne Safari",
        "modal.crios.ical.text":
            "Dessverre har Chrome pÃ¥ iOS problemer med mÃ¥ten vi genererer kalenderfilen pÃ¥.",
        "modal.crios.ical.steps":
            "<ol><li><strong>Ã…pne Safari</strong>, ...</li><li><strong>Lim inn</strong> innholdet pÃ¥ utklippstavlen og gÃ¥.</li></ol>",
        "modal.multidate.h": "Dette er en avtaleserie",
        "modal.multidate.text":
            "Legg til de enkelte datoene i kalenderen din i rekkefÃ¸lge:",
        Event: "MÃ¸te",
        ...
        "modal.subscribe.yahoo.text":
            "<ol><li>Ã…pne Yahoo-kalenderen.</li><li>Klikk pÃ¥ Â«HandlingerÂ»-fanen.</li><li>Velg Â«FÃ¸lg andre kalendereÂ».</li><li>Velg et navn og lim inn URL-en fra utklippstavlen i URL-feltet.</li></ol>",
        Cancel: "Avbryt",
    },
    fi: {
        ...
        "modal.webview.ical.text":
            "Valitettavasti sovelluksen sisÃ¤isillÃ¤ selaimilla on ongelmia kalenteritiedoston luomisessa.",
        "modal.clipboard.text":
            "Olemme automaattisesti kopioineet maagisen URL-osoitteen leikepÃ¶ydÃ¤llesi.",
        "modal.webview.ical.steps":
            "<ol><li><strong>Avaa toinen selain</strong> puhelimessasi., ...</li><li><strong>liitÃ¤</strong> leikepÃ¶ydÃ¤n sisÃ¤ltÃ¶ ja lÃ¤hde.</li></ol>",
        "modal.crios.ical.h": "Avaa Safari",
        "modal.crios.ical.text":
            "Valitettavasti iOS:n Chromessa on ongelmia kalenteritiedoston luomisessa.",
        "modal.crios.ical.steps":
            "<ol><li><strong>Avaa Safari</strong>, ...</li><li><strong>liitÃ¤</strong> leikepÃ¶ydÃ¤n sisÃ¤ltÃ¶ ja lÃ¤hde.</li></ol>",
        ...
        "modal.subscribe.yahoo.text":
            '<ol><li>Avaa Yahoo-kalenteri.</li><li>Napsauta "Toiminnot"-vÃ¤lilehteÃ¤.</li><li>Valitse "Seuraa muiden kalentereita".</li><li>Valitse nimi ja liitÃ¤ URL-osoite leikepÃ¶ydÃ¤ltÃ¤si URL-kenttÃ¤Ã¤n.</li></ol>',
        Cancel: "Peruuta",
    },
    sv: {
        ...
        "modal.webview.ical.text":
            "TyvÃ¤rr har webblÃ¤sare i appen problem med hur vi genererar kalenderfilen.",
        "modal.clipboard.text":
            "Vi har automatiskt kopierat en magisk URL till ditt klippblock.",
        "modal.webview.ical.steps":
            "<ol><li><strong>Ã–ppna en annan webblÃ¤sare</strong> pÃ¥ telefonen, ...</li><li><strong>InsÃ¤tt</strong> innehÃ¥llet i klippbordet och kÃ¶r.</li></ol>",
        "modal.crios.ical.h": "Ã–ppna Safari",
        "modal.crios.ical.text":
            "TyvÃ¤rr har Chrome pÃ¥ iOS problem med hur vi genererar kalenderfilen.",
        "modal.crios.ical.steps":
            "<ol><li><strong>Ã–ppna Safari</strong>, ...</li><li><strong>InsÃ¤tt</strong> innehÃ¥llet i klippbordet och kÃ¶r.</li></ol>",
        ...
        "modal.subscribe.yahoo.text":
            '<ol><li>Ã–ppna Yahoo-kalendern.</li><li>Klicka pÃ¥ fliken "Ã…tgÃ¤rder".</li><li>VÃ¤lj "FÃ¶lj andra kalendrar".</li><li>VÃ¤lj ett namn och klistra in URL:en frÃ¥n klippbordet i URL-fÃ¤ltet.</li></ol>',
        Cancel: "Avbryt",
    },
    cs: {
        ...
        "modal.webview.ical.text":
            "ProhlÃ­Å¾eÄe v aplikacÃ­ch majÃ­ bohuÅ¾el problÃ©my se zpÅ¯sobem generovÃ¡nÃ­ souboru kalendÃ¡Å™e.",
        "modal.clipboard.text":
            "Do schrÃ¡nky jsme automaticky zkopÃ­rovali kouzelnou adresu URL.",
        "modal.webview.ical.steps":
            "<ol><li><strong>OtevÅ™enÃ­ jinÃ©ho prohlÃ­Å¾eÄe</strong> v telefonu, ...</li><li><strong>VloÅ¾te</strong> obsah schrÃ¡nky a pÅ™ejdÄ›te.</li></ol>",
        "modal.crios.ical.h": "OtevÅ™Ã­t Safari",
        "modal.crios.ical.text":
            "Chrome v systÃ©mu iOS mÃ¡ bohuÅ¾el problÃ©my se zpÅ¯sobem generovÃ¡nÃ­ souboru kalendÃ¡Å™e.",
        "modal.crios.ical.steps":
            "<ol><li><strong>OtevÅ™Ã­t Safari</strong>, ...</li><li><strong>VloÅ¾te</strong> obsah schrÃ¡nky a pÅ™ejdÄ›te.</li></ol>",
        "modal.multidate.h": "JednÃ¡ se o sÃ©rii udÃ¡lostÃ­",
        "modal.multidate.text":
            "PÅ™idÃ¡vejte jednotlivÃ© dÃ­ly jeden po druhÃ©m:",
        Event: "UdÃ¡lost",
        ...
        "modal.subscribe.yahoo.text":
            '<ol><li>OtevÅ™ete kalendÃ¡Å™ Yahoo.</li><li>KliknÄ›te na kartu "Akce".</li><li>Vyberte moÅ¾nost "Sledovat dalÅ¡Ã­ kalendÃ¡Å™e".</li><li>Vyberte nÃ¡zev a vloÅ¾te adresu URL ze schrÃ¡nky do pole URL.</li></ol>',
        Cancel: "Storno",
    },
    ja: {
        ...
        "modal.webview.ical.text":
            "æ®‹å¿µãªãŒã‚‰ã€ã‚¢ãƒ—ãƒªå†…ãƒ–ãƒ©ã‚¦ã‚¶ã¯ã€ã‚«ãƒ¬ãƒ³ãƒ€ãƒ¼ãƒ•ã‚¡ã‚¤ãƒ«ã®ç”Ÿæˆæ–¹æ³•ã«å•é¡ŒãŒã‚ã‚Šã¾ã™ã€‚",
        "modal.clipboard.text":
            "é­”æ³•ã®URLã‚’è‡ªå‹•çš„ã«ã‚¯ãƒªãƒƒãƒ—ãƒœãƒ¼ãƒ‰ã«ã‚³ãƒ”ãƒ¼ã—ã¦ã„ã¾ã™ã€‚",
        "modal.webview.ical.steps":
            "<ol><li>ã‚¹ãƒžãƒ¼ãƒˆãƒ•ã‚©ãƒ³ã§åˆ¥ã®ãƒ–ãƒ©ã‚¦ã‚¶ã‚’èµ·å‹•ã™ã‚‹, ...</li><li>ã‚¯ãƒªãƒƒãƒ—ãƒœãƒ¼ãƒ‰ã®å†…å®¹ã‚’è²¼ã‚Šä»˜ã‘ã¦è¡Œãã€‚</li></ol>",
        "modal.crios.ical.h": "ã‚ªãƒ¼ãƒ—ãƒ³Safari",
        "modal.crios.ical.text":
            "æ®‹å¿µãªãŒã‚‰ã€iOSç‰ˆChromeã§ã¯ã€ã‚«ãƒ¬ãƒ³ãƒ€ãƒ¼ãƒ•ã‚¡ã‚¤ãƒ«ã®ç”Ÿæˆæ–¹æ³•ã«å•é¡ŒãŒã‚ã‚Šã¾ã™ã€‚",
        "modal.crios.ical.steps":
            "<ol><li><strong>ã‚ªãƒ¼ãƒ—ãƒ³Safari</strong>, ...</li><li>ã‚¯ãƒªãƒƒãƒ—ãƒœãƒ¼ãƒ‰ã®å†…å®¹ã‚’è²¼ã‚Šä»˜ã‘ã¦è¡Œãã€‚</li></ol>",
        ...
        "modal.subscribe.yahoo.text":
            "<ol><li>Yahooã‚«ãƒ¬ãƒ³ãƒ€ãƒ¼ã‚’é–‹ãã€‚</li><li>[å®Ÿè¡Œ] ã‚¿ãƒ–ã‚’ã‚¯ãƒªãƒƒã‚¯ã—ã¾ã™ã€‚</li><li>[ãã®ä»–ã®ã‚«ãƒ¬ãƒ³ãƒ€ãƒ¼ã®ãƒ•ã‚©ãƒ­ãƒ¼] ã‚’é¸æŠžã—ã¾ã™ã€‚</li><li>åå‰ã‚’æ±ºã‚ã¦ã€ã‚¯ãƒªãƒƒãƒ—ãƒœãƒ¼ãƒ‰ã«ã‚ã‚‹URLã‚’URLæ¬„ã«è²¼ã‚Šä»˜ã‘ã¾ã™ã€‚</li></ol>",
        Cancel: "ã‚­ãƒ£ãƒ³ã‚»ãƒ«",
    },
    it: {
    ...
    ko: {
        ...
        "modal.webview.ical.text":
            "ë¶ˆí–‰ížˆë„ ì¸ì•± ë¸Œë¼ìš°ì €ëŠ” ìº˜ë¦°ë” íŒŒì¼ì„ ìƒì„±í•˜ëŠ” ë°©ì‹ì— ë¬¸ì œê°€ ìžˆìŠµë‹ˆë‹¤.",
        "modal.clipboard.text":
            "ë§¤ì§ URLì„ í´ë¦½ë³´ë“œì— ìžë™ìœ¼ë¡œ ë³µì‚¬í–ˆìŠµë‹ˆë‹¤.",
        "modal.webview.ical.steps":
            "<ol><li>íœ´ëŒ€ì „í™”ì—ì„œ ë‹¤ë¥¸ ë¸Œë¼ìš°ì € ì—´ê¸°, ...</li><li>í´ë¦½ë³´ë“œ ë‚´ìš©ì„ ë¶™ì—¬ë„£ê³  ì´ë™í•©ë‹ˆë‹¤.</li></ol>",
        "modal.crios.ical.h": "Safari ì—´ê¸°",
        "modal.crios.ical.text":
            "ë¶ˆí–‰ížˆë„ iOSì˜ Chromeì€ ìº˜ë¦°ë” íŒŒì¼ì„ ìƒì„±í•˜ëŠ” ë°©ì‹ì— ë¬¸ì œê°€ ìžˆìŠµë‹ˆë‹¤.",
        "modal.crios.ical.steps":
            "<ol><li><strong>Safari ì—´ê¸°</strong>, ...</li><li>í´ë¦½ë³´ë“œ ë‚´ìš©ì„ ë¶™ì—¬ë„£ê³  ì´ë™í•©ë‹ˆë‹¤.</li></ol>",
        ...
        "modal.subscribe.yahoo.text":
            '<ol><li>Yahoo ìº˜ë¦°ë”ë¥¼ ì—½ë‹ˆë‹¤.</li><li>"ë™ìž‘" íƒ­ì„ í´ë¦­í•©ë‹ˆë‹¤.</li><li>"ë‹¤ë¥¸ ì¼ì •ê´€ë¦¬ íŒ”ë¡œìš°"ë¥¼ ì„ íƒí•©ë‹ˆë‹¤.</li><li>ì´ë¦„ì„ ì„ íƒí•˜ê³  í´ë¦½ë³´ë“œì˜ URLì„ URL í•„ë“œì— ë¶™ì—¬ë„£ìŠµë‹ˆë‹¤.</li></ol>',
        Cancel: "ì·¨ì†Œ",
    },
    vi: {
        ...
        "modal.webview.ical.text":
            "Ráº¥t tiáº¿c, cÃ¡c trÃ¬nh duyá»‡t trong á»©ng dá»¥ng gáº·p sá»± cá»‘ vá»›i cÃ¡ch chÃºng tÃ´i táº¡o tá»‡p lá»‹ch.",
        "modal.clipboard.text":
            "ChÃºng tÃ´i Ä‘Ã£ tá»± Ä‘á»™ng sao chÃ©p má»™t URL ma thuáº­t vÃ o khay nhá»› táº¡m cá»§a báº¡n.",
        "modal.webview.ical.steps":
            "<ol><li><strong> Má»Ÿ trÃ¬nh duyá»‡t khÃ¡c </strong> trÃªn Ä‘iá»‡n thoáº¡i cá»§a báº¡n, ...</li><li><strong> DÃ¡n </strong> ná»™i dung khay nhá»› táº¡m vÃ  báº¯t Ä‘áº§u.</li></ol>",
        "modal.crios.ical.h": "Má»Ÿ Safari",
        "modal.crios.ical.text":
            "Ráº¥t tiáº¿c, Chrome trÃªn iOS gáº·p sá»± cá»‘ vá»›i cÃ¡ch chÃºng tÃ´i táº¡o tá»‡p lá»‹ch.",
        "modal.crios.ical.steps":
            "<ol><li><strong>Má»Ÿ Safari</strong>, ...</li><li><strong> DÃ¡n </strong> ná»™i dung khay nhá»› táº¡m vÃ  báº¯t Ä‘áº§u.</li></ol>",
        ...
        "modal.subscribe.yahoo.text":
            '<ol><li>Má»Ÿ Lá»‹ch Yahoo.</li><li>Nháº¥p vÃ o tab "HÃ nh Ä‘á»™ng".</li><li>Chá»n "Theo dÃµi cÃ¡c Lá»‹ch khÃ¡c".</li><li>Chá»n tÃªn vÃ  dÃ¡n URL tá»« khay nhá»› táº¡m cá»§a báº¡n vÃ o trÆ°á»ng URL.</li></ol>',
        Cancel: "Há»§y bá»",
    },
};
function atcb_translate_hook(e, a) {
    ...
    return null != a.customLabels &&
        null != a.customLabels["" + t] &&
        "" != a.customLabels["" + t]
        ? atcb_rewrite_html_elements(a.customLabels["" + t])
        : atcb_translate(e, a.language);
}
...
function atcb_init() {
    if (
        (atcbInitialInit || atcb_set_global_event_listener(),
        atcb_init_log_msg(),
        isBrowser())
    ) {
            ...
            for (let e = 0; e < o.length; e++)
                o[parseInt(e)].classList.contains("atcb-initialized") ||
                    (0 !=
                        ...
                        ((null != (t = atcb_decorate_data(t)).identifier &&
                            "" != t.identifier) ||
                            (t.identifier = "atcb-btn-" + (e + n.length + 1)),
                        atcb_validate(t) &&
                            (atcb_generate_button(o[parseInt(e)], t),
...
function atcb_action(e, a, t = !0) {
    if (
        ...
        atcb_init_log_msg(),
        !atcb_check_required(
            (e = atcb_get_pro_data((e = atcb_secure_content(e))))
        ))
    )
        throw new Error(
            "Add to Calendar Button generation failed: required data missing; see console logs"
        );
    if (
        ...
        a
            ? (null != a.id && "" != a.id
              ...
              "dropdown" == e.listStyle && (e.listStyle = "overlay"))
            : ((e.identifier = "atcb-btn-custom"),
              (e.listStyle = "modal"),
              (e.trigger = "click")),
        atcb_validate(e))
        ...
        return (
            atcb_update_state_management(e),
            atcb_toggle("open", e, a, t),
            console.log(
                'Add to Calendar Button "' + e.identifier + '" triggered'
            ),
            [e.identifier]
        );
    throw new Error(
        "Add to Calendar Button generation (" +
            e.identifier +
            ") failed: invalid data; see console logs"
    );
}
function atcb_destroy(e) {
    ...
    return null != atcbStates["" + e] && a
        ? (delete atcbStates["" + e],
          (a.parentElement.parentElement.classList.contains("atcb-initialized")
          ...
          !0)
        : (console.error(
              "Add to Calendar Button could not be destroyed! ID unknown."
          ),
          !1);
}
...
function atcb_init_log_msg() {
    atcbInitialInit ||
        (console.log(
            "Add to Calendar Button Script initialized (version " +
                atcbVersion +
                ")"
        ),
        console.log(
...
function atcb_get_pro_data(e) {
    return null != e.proKey && "" != e.proKey
        ? (console.error(
              "Add to Calendar Button generation failed: proKey invalid!"
          ),
          [])
        : e;
}
                ...
                if (t.classList.contains("atcb-list-item"))
                    "ArrowDown" === a.key && t.dataset.optionNumber < n
                        ...
                        0 < e &&
                            document
                                .querySelector(
                                    '.atcb-list-item[data-option-number="' +
                                        e +
                                        '"]'
                                )
                                .focus();
                    ...
                    switch ((a.preventDefault(), a.key)) {
                        case "ArrowDown":
                            document
                                .querySelector(
                                    '.atcb-list-item[data-option-number="1"]'
                                )
                                .focus();
                            break;
                        case "ArrowUp":
        ...
        window.addEventListener(
            ...
            atcb_throttle(() => {
                var e,
                    ...
                    a =
                        (null != a &&
                            (atcb_set_fullsize(a), atcb_manage_body_scroll()),
                        document.querySelector(".atcb-active"));
                null != a &&
                    null != (e = document.querySelector(".atcb-dropdown")) &&
                    atcb_position_list(a, e, !1, !0);
            })
        ),
        window.addEventListener(
            "scroll",
            atcb_throttle(() => {
                ...
                null != a &&
                    null != (e = document.querySelector(".atcb-dropdown")) &&
                    e.classList.contains("atcb-mind-scrolling") &&
                    atcb_position_list(a, e, !1, !0);
            }, 20)
        ));
}
