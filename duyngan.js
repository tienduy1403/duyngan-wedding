...
document.write(`
	...
	<div class="mouse-scroll-on-mobile">
		<div class="mouse-scroll-on-mobile-text">KÃ©o xuá»‘ng</div>
...
if (biicore.bgMusic) {
	...
	<div class="bii-player">
		<div onclick="playPause();" class="bii-player-secondary"><div class="bii-player-secondary-content">Bật tắt nhạc tại đây nhé.</div></div>
...
if (!biicore.isPremium && !biicore.templatePremium) {
    setTimeout(function () {
        document
            .getElementsByClassName("bii-logo")[0]
            .classList.add("show-sec");
    }, 8000);
    setTimeout(function () {
        document
	...
	<div class="bii-logo"><div class="bii-logo-secondary"><div class="bii-logo-secondary-content">sađasađasads</div></div><a href="#wishes" target="_self"><img src="${biiLogo}" /></a></div>
